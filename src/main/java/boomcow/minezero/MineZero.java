...
public class MineZero {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "MineZero" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "MineZero" namespace
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);

    // Creates a new Block with the id "MineZero:example_block", combining the namespace and path
